...
import { FiPackage, FiDollarSign, FiCalendar, FiPlus, FiX, FiSave, FiImage, FiArrowRight } from "react-icons/fi";
          ...
          <div className="flex gap-3">
            <motion.button 
              ...
              className={`px-6 py-2.5 rounded-xl transition-all ${
                isDraft ? 'bg-gradient-to-r from-[#016A6D] to-[#043E52] text-white' : 'bg-[#016A6D]/10 text-[#043E52]'
              } disabled:opacity-50`}
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              ...
              <div className="space-y-2">
                <label htmlFor="startingPrice" className="block text-sm font-medium text-[#043E52]">Starting Price*</label>
                <input 
                  type="number" 
                  id="startingPrice"
