...
const AddProduct = () => {
  const [productImages, setProductImages] = useState([
    ...
    '/images/controller-angle1.jpg',
    '/images/controller-angle2.jpg'
  ]);
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-6">
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <nav className="text-sm md:text-base">
              <ol className="flex items-center space-x-2">
                ...
                <li>/</li>
                <li><a href="#" className="hover:text-red-600 transition-colors">Dashboard</a></li>
                <li>/</li>
          ...
          <div className="w-full md:w-auto">
            <button 
              type="button"
              className="w-full md:w-auto bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded transition-all duration-300 ease-in-out transform hover:scale-105"
            >
              Save Draft
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white border rounded-lg p-6 shadow-sm">
              ...
              <div className="mt-4">
                <label htmlFor="bidIncrease" className="block text-sm font-medium text-gray-700 mb-2">Accept Bid Increase (%)</label>
                <input 
                  type="number" 
                  id="bidIncrease"
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border rounded-lg p-4 shadow-sm">
              ...
              <div className="flex flex-wrap gap-2">
                {productImages.map((img, index) => (
                  <div 
                    key={index}
                    className={`border cursor-pointer w-16 h-16 md:w-20 md:h-20 flex items-center justify-center rounded 
            ...
            {/* Date Range */}
            <div className="bg-white border rounded-lg p-6 shadow-sm">
              <h2 className="text-2xl font-bold text-red-600 mb-4">Date</h2>
            ...
            <div className="mt-6">
              <button 
                type="submit"
                className="w-full bg-red-600 hover:bg-red-700 text-white px-4 py-3 rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 shadow-md"
              >
                Add Product
              </button>
            </div>
