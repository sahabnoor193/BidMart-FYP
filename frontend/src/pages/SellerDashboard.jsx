...
//         // Update profile data format to match new structure
...
//     try {
//       const token = localStorage.getItem('token');
//       // Format the data back to the API expected format
//       const profileData = {
//         name: `${userProfile.firstName} ${userProfile.lastName}`.trim(),
//         email: userProfile.email,
//         address: userProfile.address,
//         password: userProfile.newPassword || undefined
//       };
...
//           </div>
//           <div>
//             <label htmlFor="currentPassword" className="block text-gray-700 font-medium mb-1">Password Changes</label>
//             <input
//               type="password"
//               id="currentPassword"
...
//               onChange={(e) => setUserProfile({ ...userProfile, confirmNewPassword: e.target.value })}
//               className="w-full border border-gray-300 rounded p-2"
//             />
//           </div>
...
const SellerDashboard = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-gray-100 mt-16">
      {/* Sidebar */}
